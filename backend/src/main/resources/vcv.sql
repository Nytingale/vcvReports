...
CREATE TABLE `Company`(
    id BIGINT AUTO_INCREMENMT NOT NULL,
    name VARCHAR(64) NOT NULL,
    type ENUM('VCV Staff', 'Delearship', 'Insurance', 'Garage', 'Mechanic', 'Casual') DEFAULT 'Casual',
...
ALTER TABLE `Job`     ADD CONSTRAINT job_claim_fk      FOREIGN KEY(claim_number, insurance_name) REFERENCES Claim(company_id, claim_number);
...
ALTER TABLE `Vehicle` ADD CONSTRAINT vehicle_policy_fk FOREIGN KEY(policy_number, insurance_id)  REFERENCES Policy(company_id, policy_number);
